# Django settings for opal_practice project.
import os
...
SECRET_KEY = '7lvs!6l+vhlzdjkm%d(t$4hq7zg9g3ojv(d-pezed%6+t-3ne6'
...
ROOT_URLCONF = 'opal_practice.urls'
APPEND_SLASH = False
...
WSGI_APPLICATION = 'opal_practice.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = (
    'opal_practice.migrations',
    'opal_practice.tests',
    'opal_practice.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://opal_practice.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'opal_practice'
